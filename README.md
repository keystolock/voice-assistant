...
- Capable of launching .exe files in system
...
# Usage
Run the progam using : python assistance.py <br>
Say "google" to activate for tasks <br>
Say "exit/stop" to terminate the program
